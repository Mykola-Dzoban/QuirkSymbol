...
export interface PresenceEntry {
	...
	cursorY: number;
	updatedAt: number;
	/** Учасник зараз тягне лазерну указку (`Tool.laser`, мишу затиснуто) — курсор варто рендерити як
	 *  згасаючий слід замість звичайної іконки-стрілки. */
...
/** Скільки мс лишається на екрані (і згасає) точка лазерного сліду після того, як перестала оновлюватись. */
