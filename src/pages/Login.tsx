...
export default function Login() {
	...
	return (
		<div className="flex h-full flex-col items-center justify-center gap-6 bg-page-bg px-4 text-center">
			...
			<Button size="lg" onClick={loginWithGoogle} isLoading={isLoggingIn}>
				Увійти через Google
			</Button>
