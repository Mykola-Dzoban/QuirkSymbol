	...
	return (
		<div className="container mx-auto">
			...
			<div className="flex flex-col items-center gap-4 justify-center">
				<svg width="100px" height="100px" viewBox="0 0 128 128" aria-hidden="true" role="img" className="iconify iconify--noto" preserveAspectRatio="xMidYMid meet">
					<path
					...
					<path d="M15.62 32.75c-.52 3.64 1.09 9.12 2.44 9.04c1.12-.07 1.38-2.29 1.38-2.29s.96 2.84 2.72 2.66c1.68-.18 1.6-6.19 2.03-9.13l-5.7-2.33l-2.87 2.05z" fill="#ffecb3"></path>
					<path d="M11.84 15.91c.33-1.02 1.26-2.35 2.77-2.31c1.61.05 1.33 2.36.78 3.58c-.56 1.22-1.85 2.4-3.06 1.64c-.83-.52-.72-2.19-.49-2.91z" fill="#212121"></path>
					<path
