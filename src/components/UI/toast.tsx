...
import { newElementId } from '../../domain/board';
...
export const Toaster: React.FC = () => {
	...
	return (
		<div className="fixed bottom-4 right-4 z-100 flex flex-col gap-2">
			{toasts.map((t) => (
				<div key={t.id} className="flex items-center gap-2 rounded-md border border-panel-border bg-panel px-3 py-2 text-sm shadow-lg">
					{icons[t.kind]}
					<span>{t.message}</span>
